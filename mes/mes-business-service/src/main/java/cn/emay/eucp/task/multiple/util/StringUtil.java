...
public class StringUtil {
	...
	static Pattern checkSendTimePattern = Pattern.compile(
	...
	public static boolean checkSendTime(String sendtime) {
		try {
			return checkSendTimePattern.matcher(sendtime).matches();
		} catch (Exception e) {
			log.error("Exception is happened!", e);
			return false;
		}
	...
	// 拼接内容参数
	public static String getContent(String templateContent, String templateParam) {
		Map<String, String> map = JsonHelper.fromJson(new TypeToken<Map<String, String>>() {
		}, templateParam);
		String content = templateContent;
		for (Entry<String, String> entry : map.entrySet()) {
			String key = TemplateInfoParseUtil.LEFT_SIGN_STRING + entry.getKey() + TemplateInfoParseUtil.RIGHT_SIGN_STRING;
