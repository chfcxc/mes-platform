...
<temple:write property="head">
	<link rel="stylesheet" href="${WEB_STATIC_PATH}/css/manage/base/business.css" type="text/css" />
</temple:write>
...
<script type="text/javascript" src="${WEB_STATIC_PATH}/js/manage/accounts/fmsaccounts.js"></script>
