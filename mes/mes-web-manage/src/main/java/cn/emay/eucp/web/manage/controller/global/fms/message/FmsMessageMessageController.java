...
@PageAuth("FMS_MESSAGE_DETAIL")
@RequestMapping("/fms/message/detail")
@Controller
public class FmsMessageMessageController {
	@Resource
	...
	public void list(HttpServletRequest request, HttpServletResponse response) {
		...
		if (page.getList() != null && page.getList().size() > 0) {
			...
			for (FmsMessagePageDto fmsBatchPageDto : page.getList()) {
				...
				fmsBatchPageDto.setChannelReportStr(EucpFmsMessageState.findNameByCode(fmsBatchPageDto.getChannelReportDesc()));
			}
		}
