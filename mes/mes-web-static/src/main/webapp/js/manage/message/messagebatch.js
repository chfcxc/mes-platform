...
var emTableConfig = {
	...
	searchConfig : {
		searchItems : [ {
			...
			// 状态 1发送中 2发送到运营商 3发送成功 4发送失败 5发送超时
...
//			}
	...
	ajaxConfig : {
		url : WEB_SERVER_PATH + '/fms/message/batch/ajax/list',
		method : 'POST',
		data : {
...
function seeDetail(batchNumber){
	window.location.href=WEB_SERVER_PATH + '/fms/message/detail?batchNumber='+batchNumber;
}
$(function(){
