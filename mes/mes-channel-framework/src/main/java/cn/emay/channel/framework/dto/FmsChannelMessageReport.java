...
public class FmsChannelMessageReport {
	...
	public FmsChannelMessageReport(String channelReportTime, String mobile, String operatorFmsId, String state, String stateDesc) {
		super();
	...
	public FmsChannelMessageReport() {
