	...
	<div class="header">
		<div class="container">
			<div class="clientLogo">
				<a id="logo" class="logo disno" href="${BUS_DOMAIN_PATH}/${BUS_SYSTEM.toLowerCase()}sms/index"></a>
				<h2><a href="${BUS_DOMAIN_PATH}/${BUS_SYSTEM.toLowerCase()}sms/index">亿美 · 统一通信平台</a></h2>
			</div>
		</div>
	</div>
	<div class="open_box">
	...
	<div class="nav_list_div">
		<ul id="navList" class="nav_list">
			<li class="sms_module nav_item" code = "INDEX">
				<a href="${BUS_DOMAIN_PATH}/${BUS_SYSTEM.toLowerCase()}sms/index">
				    <span class="nav-ico nav-ico-10"></span> 
                    <span class="nav-primary j-arrow">首页</span>
                  </a>
			</li>
			<c:forEach items="${TREE.children}" var="moudle">
                   <li class="sms_module nav_item" code = "${moudle.resource.resourceCode}">
