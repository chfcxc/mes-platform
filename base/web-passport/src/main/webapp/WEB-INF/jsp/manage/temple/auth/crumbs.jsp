		...
		<div class="helpbox">
			<dl>
				<dd>
					...
					<ul>
						<li><a href="${BUS_DOMAIN_PATH}/${BUS_SYSTEM.toLowerCase()}/helper/updateInfo" title="系统更新">系统更新</a></li>
						<li><a href="${BUS_DOMAIN_PATH}/${BUS_SYSTEM.toLowerCase()}/helper/fqa" title="FQA">FQA</a></li>
					</ul>
				</dd>
			</dl>
		</div>
