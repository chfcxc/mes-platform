...
<head>
	...
	<link type="image/x-icon" rel="shortcut icon" href="${WEB_STATIC_PATH}/img/sale/favicon.ico">
	<link type="image/x-icon" rel="bookmark" href="${WEB_STATIC_PATH}/img/sale/favicon.ico">
	<link type="image/x-icon" rel="icon" href="${WEB_STATIC_PATH}/img/sale/favicon.ico">
	<link type="text/css" href="${WEB_STATIC_PATH}/css/sale/common.css" rel="stylesheet" />
	<link type="text/css" href="${WEB_STATIC_PATH}/css/sale/noauthtemple.css" rel="stylesheet" />
	<link type="text/css" href="${WEB_STATIC_PATH}/css/sale/validate.css" rel="stylesheet" />
...
<body>
    <div class="login_header">
        <div class="login_main">亿美 · 统一通信平台·销售系统 </div>
    </div>
