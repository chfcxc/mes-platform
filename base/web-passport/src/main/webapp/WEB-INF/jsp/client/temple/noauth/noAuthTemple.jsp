...
<head>
	...
	<link type="text/css" href="${WEB_SERVER_PATH}/css/client/common.css" rel="stylesheet" />
	<link type="text/css" href="${WEB_SERVER_PATH}/css/client/noauthtemple.css" rel="stylesheet" />
	<link type="text/css" href="${WEB_SERVER_PATH}/css/client/validate.css" rel="stylesheet" />
...
<body>
    <div class="login_header">
        <div class="login_main"><!-- <span>亿美 · 统一通信平台</span> --></div>
    </div>
