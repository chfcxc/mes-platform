...
<script type="text/javascript" src="${WEB_STATIC_PATH}/lib/md5.js"></script>
   <script type="text/javascript" src="${WEB_STATIC_PATH}/js/client/golable/problem.js"></script> 
<script type="text/javascript" src="${WEB_STATIC_PATH}/lib/Highcharts/highcharts.js"></script>
<script type="text/javascript" src="${WEB_STATIC_PATH}/lib/Highcharts/themes/grid-light.js"></script>
