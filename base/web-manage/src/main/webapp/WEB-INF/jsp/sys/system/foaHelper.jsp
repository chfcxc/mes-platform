...
<temple:write property="head">
	 <link rel="stylesheet" href="${WEB_STATIC_PATH}/css/manage/system/foaHelper.css" type="text/css" /> 
...
<script type="text/javascript" src="${WEB_STATIC_PATH}/js/manage/sys/system/foaHelper.js"></script>
