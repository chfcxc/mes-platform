...
<div id="crumbsForPage">${CURRENT_PAGE_NAME}</div>

<div id="crumbsForPageUrl">${WEB_SERVER_PATH}${CURRENT_PAGE_URL}</div>

<div id="crumbsForNav">${CURRENT_NAV_NAME}</div>

<div id="crumbsForMoudle">${CURRENT_MOUDLE_NAME}</div>

<div id="crumbsForSupport"><temple:block property="crumbs" /></div>
