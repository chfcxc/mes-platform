...
<temple:write property="head">
	<link rel="stylesheet" href="${WEB_STATIC_PATH}/css/client/accountinfo/accountinfo.css" type="text/css" />
</temple:write>
...
<div class="personalInformation">
	...
	<ul class="ulBox">
		...
		<li><label>姓&nbsp;&nbsp;&nbsp;&nbsp;名：</label><span>${user.realname}</span><input value="修 改" onclick="modifyrn('${user.realname}')" type="button"></li>
...
<form method="post"  id="changepw" class="changepw">
       ...
       <div class="item">
        ...
        <div class="tipFoot">
           ...
           <button class="tipBtn tip-cancel" type="button" onclick="javascript:goPage('/sys/client/userinfo');">取 消</button>
       </div>
      </fieldset>
</form>
</div>
...
<script type="text/javascript" src="${WEB_STATIC_PATH}/js/client/sys/accountinfo/accountinfo.js"></script>